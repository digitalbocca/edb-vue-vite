  ...
  <div class="relative top-0 left-0 w-80 h-[49px]">
    <div class="absolute w-80 h-[49px]">
      ...
      <input
        id="text-input"
        v-model="model"
        class="text-input w-full bg-white rounded-sm py-2 px-4 border border-gray-300 border-2 transition-colors duration-200 ease-in-out focus:border-2 focus:outline-hidden focus:border-color-lime-500 focus:transition-colors focus:duration-200 focus:ease-in-out focus:ring-transparent focus:ring-0"
        type="text"
        autocomplete="off"
